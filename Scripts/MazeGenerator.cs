...
public class MazeGenerator : MonoBehaviour {
    ...
    public MazeCell[,] GetMaze() { // створюється сітка з клітинками зі всіма стінами
    ...
    void CarvePath(int x, int y) // проходить по клітинках та створює коридори (розбиває стіни)
    {
        if (x < 0 || y < 0 || x > mazeWidth - 1 || y > mazeHeight - 1)
        {
            x = y = 0;
